...
model_name = f"CNN_Handwritten_OCR_CNN_{n_cnn1planes}_planes_{n_epochs}_epochs"
# figure_format='svg'
figure_format = 'png'
figure_path = './results'
log_path = './log'
...
cnn4 = Conv2D(n_cnn1planes*8, kernel_size=(n_cnn1kernel, n_cnn1kernel),
              strides=(n_strides, n_strides), padding='valid', activation='relu')
model.add(cnn4)
model.add(MaxPool2D(pool_size=(n_poolsize, n_poolsize)))
